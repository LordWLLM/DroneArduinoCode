...
void loop()
{
  ...
  */
  ...
  float a[] = {0, 0, 0, 0, 0, 0, inAccX, inAccY, inAccZ, mx, my, mz, q[0], q[1], q[2], q[3], gx, gy, gz, 0, 0, 0, 0};
...
void displayInfo()
{
  ...
  {
    Serial.print(gps.speed.kmph() / 3.6f);
    Serial.print(F("m/s"));
  }
  else
  {
